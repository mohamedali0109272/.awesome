...
local top_panel2 = function(s, offset)
	...
	local panel = wibox
	{
		...
		type = 'dock',
		height = dpi(28),
		width = 300 ,--s.geometry.width  - 1300, --625,
	...
	local ram = awful.widget.watch('sh -c ' .. config_dir .. '/configuration/status/ram.sh',10)
	local temp = awful.widget.watch('sh -c ' .. config_dir .. '/configuration/status/temp.sh',60)
