...
local top_panel2 = require('layout.top-panel2')
local top_panel3 = require('layout.top-panel3')
...
screen.connect_signal(
	...
	function(s)
		if s.index == 1 then
			...
			s.top_panel2 = top_panel2(s, true)
			s.top_panel3 = top_panel3(s, true)
		else
			s.top_panel = top_panel(s, false)
			s.top_panel2 = top_panel2(s, false)
			s.top_panel3 = top_panel3(s, false)
		end
...
function update_bars_visibility()
	for s in screen do
		if s.selected_tag then
			...
			s.top_panel2.visible = not fullscreen
			s.top_panel3.visible = not fullscreen
